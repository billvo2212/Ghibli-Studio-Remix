...
//loaders -> for server side -> non client side
...
// client side -> appears on the browser 
        ...
        <div className="p-16 font-sans">
            ...
            <Form reloadDocument method="get" className="py-5">
                <label className="font-bold">
                    Search{' '}
                    <input type="text" name="title" placeholder="Type a title..." className="border-2 round py-2 px-3" />
                </label>
